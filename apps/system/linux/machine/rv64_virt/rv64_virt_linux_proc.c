...
static int rv64_virt_linux_proc_irq_handler(int vect_id, void *data)
{
...
#endif /* #ifndef RPMSG_NO_IPI */

static struct remoteproc *
rv64_virt_linux_proc_init(struct remoteproc *rproc,
			  struct remoteproc_ops *ops, void *arg)
{
	...
	metal_irq_register(irq_vect, rv64_virt_linux_proc_irq_handler, rproc);
...
static void rv64_virt_linux_proc_remove(struct remoteproc *rproc)
{
	struct remoteproc_priv *prproc;
	struct metal_device *dev;
...
static void *
rv64_virt_linux_proc_mmap(struct remoteproc *rproc, metal_phys_addr_t *pa,
...
static int rv64_virt_linux_proc_notify(struct remoteproc *rproc, uint32_t id)
{
	struct remoteproc_priv *prproc;
...
struct remoteproc_ops rv64_virt_linux_proc_ops = {
	.init = rv64_virt_linux_proc_init,
	.remove = rv64_virt_linux_proc_remove,
	.mmap = rv64_virt_linux_proc_mmap,
	.notify = rv64_virt_linux_proc_notify,
	.start = NULL,
	.stop = NULL,
	.shutdown = NULL,
};
